...
const CLEFAPI = '9276c2153c7e3b012a23b91a0d1cdb97';
let resultatsAPI;
...
function AppelAPI(long, lat) {
    ...
    .then((data) => {
        ...
        // Icone dynamique 
             imgIcone.src = `ressources/grand/${resultatsAPI.current.weather[0].description}.png`;
             for(let m = 0; m < 7; m++){
                imgjour[m].src = `ressources/petit/${resultatsAPI.daily[m+1].weather[0].description}.png`;
                console.log(resultatsAPI.daily[m+1].weather[0].description);
            }            
    })
